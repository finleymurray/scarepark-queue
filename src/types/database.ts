...
export type AuditActionType = 'queue_time_change' | 'status_change' | 'throughput_entry' | 'show_time_added' | 'show_time_removed' | 'attraction_created' | 'attraction_deleted' | 'signoff_completion' | 'show_report_submission' | 'operator_login' | 'operator_logout' | 'monitor_hold_request' | 'monitor_hold_cleared';
