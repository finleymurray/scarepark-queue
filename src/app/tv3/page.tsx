          ...
          >
            {shows.map((show) => {
              ...
              return (
                ...
                >
                  {/* Show Name */}
                  <h2 className="text-white text-[4vw] font-black text-center leading-tight mb-auto">
                    {show.name}
                  </h2>
                  ...
                  <div className="text-center mt-auto">
                    {show.status === 'DELAYED' ? (
                      ...
                      <>
                        <p className="text-white/50 text-[1.5vw] font-semibold uppercase tracking-wider mb-2">
                          Next Show
                        </p>
